...
/**
 * Ability that boosts chance of catching rare fish
 */
export class RarityBoostAbility extends FishAbility {
    // Amount to boost rarity chance by (percentage as decimal, e.g., 0.1 = +10% chance)
    ...
    constructor(
        ...
        super(id, name, description, isPassive, isPassive ? 0 : 360000); // 6 minute cooldown for active abilities
